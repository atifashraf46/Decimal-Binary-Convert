...
convertBtn.addEventListener("click", () => {
  ...
  if (!isNaN(num) && num >= 0) {
    result.textContent = decimalToBinary(num);
  } else {
    result.textContent = "Please enter a valid non-negative number.";
  }
});

// ✅ Final requirement: set result to decimalToBinary(5)
result.textContent = decimalToBinary(5); // This sets initial test value
